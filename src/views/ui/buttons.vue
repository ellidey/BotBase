          ...
          <div class="card-body">
            ...
            <div class="live-preview">
              <div class="d-flex flex-wrap gap-2">
                <b-button variant="primary" class="waves-effect waves-light"
                  >Primary</b-button
                >

                <b-button
                  variant="secondary"
                  class="dary waves-effect waves-light"
                >
                  Secondary
                </b-button>
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="outline-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
            ...
            <div class="live-preview">
              <div class="d-flex flex-wrap gap-2">
                <b-button
                  ...
                  class="waves-effect waves-light shadow-none"
                >
                  Primary
                </b-button>
                <b-button
                ...
                <b-button
                  ...
                  class="waves-effect shadow-none"
                >
                  Light
                </b-button>
              </div>
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="rounded-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="soft-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            ...
            <div class="live-preview">
              <div class="d-flex flex-wrap gap-2">
                ...
                <b-button
                  class="btn btn-soft-info waves-effect waves-light shadow-none"
                >
                  Info
                </b-button>
                <b-button
                ...
                <b-button
                  class="btn btn-soft-dark waves-effect waves-light shadow-none"
                >
                  Dark
                </b-button>
              </div>
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="gradient-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            ...
            <div class="live-preview">
              <div class="d-flex flex-wrap gap-2">
                <b-button
                  variant="primary"
                  class="bg-gradient waves-effect waves-light"
                >
                  Primary
                </b-button>
                <b-button
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="animation-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="label-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="size-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="width-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            ...
            <div class="live-preview">
              <div class="d-flex flex-wrap gap-2">
                <b-button
                  variant="primary"
                  class="w-xs waves-effect waves-light"
                >
                  Xs
                </b-button>
                <b-button
                ...
                <b-button
                  variant="success"
                  class="w-lg waves-effect waves-light"
                >
                  Large
                </b-button>
              </div>
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="tag-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="toggle-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="grid-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="checkbox-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
            ...
            <div class="live-preview">
              <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                >
                  ...
                  />
                  <label
                    class="btn btn-outline-secondary shadow-none mb-0"
                    for="btnradio1"
                    >Radio 1</label
                  >
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="group-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="icon-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="hstack gap-2 mt-4 mt-sm-0">
                    <b-button
                      variant="outline-primary"
                      class="btn-icon waves-effect waves-light shadow-none"
                    >
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="toolbar-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="group-size-button" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="vertical-variation" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
